...
logger = logging.getLogger("azuresql_mcp_server")
...
# Initialize server
server = Server("azuresql_mcp_server", lifespan=server_lifespan)
        ...
        try:
            await server.run(
                ...
                InitializationOptions(
                    server_name="azuresql_mcp_server",
                    server_description="Azure SQL MCP Server",
